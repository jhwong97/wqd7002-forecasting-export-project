...
with DAG(
    ...
    task1 = PythonOperator(
        ...
        op_kwargs={"url": url,
                   ...
                   "bucket_name": bucket_name,
                   "blob_name": ["my_import_request.html"],
                   "file_format": "html",
    ...
    task2 = PythonOperator(
        ...
        op_kwargs={"client": storage_client,
                   "bucket_name": bucket_name,
                   "blob_name": ["my_import_raw_data.csv"],
                   "file_format": "csv",}
    )
    ...
    task3 = PythonOperator(
        ...
        op_kwargs={"client": storage_client,
                   "new_column_name": "my_total_import",
                   "bucket_name": bucket_name,
                   "blob_name": ["my_import_transformed_data.csv"],
                   "file_format": "csv",}
    )
